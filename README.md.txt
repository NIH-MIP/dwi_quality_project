...
-- folder: prostatex - select images from the ProstateX cohort are included, converted into .nii.gz format. 
	--- prostatex_decoder.csv - a spreadsheet decoder that lists whether each patient case was included in the train, validation, or test cohort.
